...
public class Piechart_Distribution extends AppCompatActivity {
    PieChartView pieChartView;
    TextView demototal,demodistri;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_piechart__distribution);
        ...
        pieData.add(new SliceValue(t1, Color.CYAN).setLabel("Total:"+s1));
        pieData.add(new SliceValue(t2, Color.RED).setLabel("Served:"+s2));


        PieChartData pieChartData = new PieChartData(pieData);
        pieChartData.setHasLabels(true).setValueLabelTextSize(14);
        pieChartData.setHasCenterCircle(true).setCenterText1("Today's Distribution").setCenterText1FontSize(20).setCenterText1Color(Color.parseColor("#62ed2f"));
